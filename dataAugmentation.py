...
def createDatasets(trainSize, validationSize):
    ...
    """
    #*************************************************************************#
    Split dataset by patient level
    #*************************************************************************#
    """
    ALLtrainPat = []
    ALLvalidPat = []
    ...
    pTrain1 = mp.Process(name='Train1 Augm', target=createAugm_rndDiv_train)
    pValid1 = mp.Process(name='Validation1 Augm', target=createAugm_rndDiv_valid)
    pTrain2 = mp.Process(name='Train2 Augm', target=createAugm_patLvDiv_train)
    pValid2 = mp.Process(name='Validation2 Augm', target=createAugm_patLvDiv_valid)
...
if __name__ == '__main__':
    ...
    createDatasets(trainSize=40000, validationSize=10000) #Sample Data
    print(f"\nEnd Script!\n{'#'*50}")
