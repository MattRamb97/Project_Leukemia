% FASE DI INSTALLAZIONE DI VLFEAT E MATCONVNET CHE PERO' EFFETTUO IN MODO MANUALE 

% run(fullfile(fileparts(mfilename('fullpath')), ...
%     '..', 'matconvnet', 'matlab', 'vl_setupnn.m')) ;

% FASE DI ADDESTRAMENTO DELLE RESNET
...
%% FASE DI CALCOLO DELLE LABEL, DELLO SCORE E DELLE PREDICTION LABEL TRAMITE LA RESNET50 ADDESTRATA

[lb50_0123_4, sc50_0123_4, pr50_0123_4] = evaluate_cell('trainset', [0,1,2,3], 'testset', -1, 'whichresnet', 50);

% ordinamento dello score in ordine ascendente
...
% FASE DI CORREZIONE DELLE PREDICTION LABELS TRAMITE ALGORITMO DI NEIGHBORHOOD CORRECTION
